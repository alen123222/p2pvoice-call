...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'en': {
      'identityConflict':
          'This ID is active on another device. Change your ID or reconnect.',
      'homeHeadline': 'A little closer.',
      'homeSubtitle': 'A familiar voice, wherever you are.',
      'dialHeading': 'Make a call',
      'dialDescription': 'Enter a device ID to start a conversation.',
      'peerId': 'Device ID',
      'privacyNote': 'Audio is encrypted with DTLS-SRTP. A relay is used when a direct connection is unavailable.',
      'retry': 'Retry',
      'refresh': 'Refresh devices',
      'settings': 'Settings',
      'appearance': 'Appearance',
      'network': 'Network',
      'networkSaveHint': 'Save to reconnect with these network settings.',
      'invalidId': 'Use 1–64 letters, numbers, underscores, dots or hyphens.',
      'invalidServer': 'Enter a valid ws:// or wss:// address.',
      'invalidStun': 'Enter a valid STUN host and optional port.',
      'saveFailed': 'Could not save. Please try again.',
      'callConnected': 'Connected',
      'callConnecting': 'Calling',
      'incomingHint': 'Someone wants to talk to you.',
      'encrypted': 'Encrypted audio',
      'transportUnknown': 'Checking connection',
      'transportDirect': 'Direct connection',
      'transportRelay': 'Encrypted TURN relay',
      'audioRouteFailed': 'Could not change audio output.',
      'theme_sakuraSmoke': 'Rose',
      'theme_cloudRiver': 'Sky',
      'theme_roseAmber': 'Amber',
      'theme_teaFluo': 'Sage',
      ...
      'secureNotice': 'Secure direct: audio is transmitted peer-to-peer over hardware-encrypted DTLS-SRTP, with zero cloud storage, protected from eavesdropping and tampering.',
      ...
      'settingsNote': 'Note: changes are saved automatically and the signaling service reconnects.',
    ...
    'zh': {
      'identityConflict': '此 ID 已在另一台设备登录，请修改 ID 或重新连接。',
      'homeHeadline': '让声音，拉近距离。',
      'homeSubtitle': '无论相隔多远，听见熟悉的声音。',
      'dialHeading': '开始一段对话',
      'dialDescription': '输入对方的设备 ID，即可发起语音通话。',
      'peerId': '对方设备 ID',
      'privacyNote': '语音通过 DTLS-SRTP 加密；无法直连时使用中继传输。',
      'retry': '重新连接',
      'refresh': '刷新设备',
      'settings': '设置',
      'appearance': '外观',
      'network': '网络连接',
      'networkSaveHint': '保存后将使用新的网络设置重新连接。',
      'invalidId': '请输入 1–64 位字母、数字、下划线、点或短横线。',
      'invalidServer': '请输入有效的 ws:// 或 wss:// 地址。',
      'invalidStun': '请输入有效的 STUN 主机和可选端口。',
      'saveFailed': '保存失败，请重试。',
      'callConnected': '通话中',
      'callConnecting': '正在呼叫',
      'incomingHint': '有一段对话，正等待你的回应。',
      'encrypted': '语音已加密',
      'transportUnknown': '正在确认连接方式',
      'transportDirect': '点对点直连',
      'transportRelay': '加密 TURN 中继',
      'audioRouteFailed': '切换音频输出失败。',
      ...
      'unknownUser': '未知设备',
      'secureNotice': '安全直连：音频流在手机间通过硬件级 DTLS-SRTP 密文点对点传输，零云端存储，防窃听防篡改。',
      'dialTitle': '发起 P2P 呼叫',
    ...
    'fr': {
      'identityConflict': 'Cet identifiant est actif sur un autre appareil. Modifiez-le ou reconnectez-vous.',
      'homeHeadline': 'Un peu plus proches.',
      'homeSubtitle': 'Une voix familière, où que vous soyez.',
      'dialHeading': 'Passer un appel',
      'dialDescription': 'Saisissez un identifiant pour commencer.',
      'peerId': 'Identifiant du destinataire',
      'privacyNote': 'Audio chiffré par DTLS-SRTP. Un relais est utilisé si la connexion directe est impossible.',
      'retry': 'Réessayer',
      'refresh': 'Actualiser',
      'settings': 'Réglages',
      'appearance': 'Apparence',
      'network': 'Connexion réseau',
      'networkSaveHint': 'Enregistrez pour vous reconnecter avec ces réglages.',
      'invalidId': 'Utilisez 1 à 64 lettres, chiffres, points, tirets ou traits de soulignement.',
      'invalidServer': 'Saisissez une adresse ws:// ou wss:// valide.',
      'invalidStun': 'Saisissez un hôte STUN valide et un port facultatif.',
      'saveFailed': 'Échec de l’enregistrement. Réessayez.',
      'callConnected': 'En communication',
      'callConnecting': 'Appel en cours',
      'incomingHint': 'Une personne souhaite vous parler.',
      'encrypted': 'Audio chiffré',
      'transportUnknown': 'Vérification de la connexion',
      'transportDirect': 'Connexion directe',
      'transportRelay': 'Relais TURN chiffré',
      'audioRouteFailed': 'Impossible de changer la sortie audio.',
      'theme_sakuraSmoke': 'Rose',
      'theme_cloudRiver': 'Ciel',
      'theme_roseAmber': 'Ambre',
      'theme_teaFluo': 'Sauge',
      ...
      'secureNotice': 'Connexion directe sécurisée : l’audio est transmis en pair-à-pair via DTLS-SRTP chiffré, sans stockage cloud, protégé contre les écoutes et les altérations.',
      ...
      'settingsNote': 'Remarque : les modifications sont enregistrées et le service de signalisation se reconnecte.',
